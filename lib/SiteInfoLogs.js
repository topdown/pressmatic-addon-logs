...
module.exports = function (context) {
	...
	return function (_Component) {
		...
		function SiteInfoLogs(props) {
			...
			_this.showWPError = _this.showWPError.bind(_this);
			...
			_this.WPErrorLog = path.resolve(this.site.path, 'app/public/wp-content/');
		...
		_createClass(SiteInfoLogs, [{
			...
			key: 'showWPError',
			value: function showWPError() {
				this.viewTitle = 'WP Error Log';
				this.activeView = 'wpError';
				this.getLog( this.WPErrorLog + '/debug.log', this.activeView);
			}
		}, {
			key: 'render',
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ style: { display: this.activeView === 'wpError' ? 'block' : 'none' },
								className: 'padded-horizontally-more logview-monitor wpError' }
							)
						),
						React.createElement(
							'div',
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'button',
										{ className: 'btn btn-default btn-small',
											disabled: this.activeView && this.activeView === 'wpError',
											onClick: this.showWPError },
										'WP Error'
									)
								)
							)
